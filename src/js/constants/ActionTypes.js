...
export const SET_SWITCHER_COLOR = 'SET_SWITCHER_COLOR';
...
export const TOGGLE_SIZE_DROPDOWN = 'TOGGLE_SIZE_DROPDOWN';
export const TOGGLE_FORMAT_DROPDOWN = 'TOGGLE_FORMAT_DROPDOWN';
